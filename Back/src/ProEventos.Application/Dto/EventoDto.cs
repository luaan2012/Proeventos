...
namespace ProEventos.Application.Dto
{
    public class EventoDto
    {
        ...
        [Range(1, 1200, ErrorMessage = "{0} não pode ser menor que 1 e maior que 120.000")]
        public int QtdPessoas { get; set; }
        [RegularExpression(@"/.*\.(gif|jpe?g|bmp|png)$/igm", ErrorMessage = "Não é uma imagem valida.(gif, jpg, jpeg, bmp, ou png")]
        ...
        [Required(ErrorMessage = "O campo {0} é obrigatório."),
        Display(Name = "e-mail"),
        EmailAddress(ErrorMessage = "É necessario o {0} ser válido")]
